...
import vicode.dialogs.RemoveStateAsker;
import vicode.dialogs.NewStateDialog;
import vicode.dialogs.RemoveComponentAsker;
import vicode.dialogs.RemoveTransitionAsker;
import vicode.dialogs.RemoveConnectionAsker;
import vicode.dialogs.NewComponentDialog;
...
public class BuilderGUI extends PCanvas {
	...
	public final static String AUXCLASS_BEGIN = "//BUILDER COMMENT. DO NOT REMOVE. auxclass begin";
	public final static String AUXCLASS_END = "//BUILDER COMMENT. DO NOT REMOVE. auxclass end";
	...
	public void setAuxCHCode(String CHcode) {
		auxcodeCH = AUXCLASS_BEGIN + "\n" + CHcode + AUXCLASS_END + "\n";
	}
