...
public class CodeGenerator {
	...
	public CodeGenerator() {
		...
		auxcodeCH   = builderGUI.getAuxcodeCH();
	...
	public String generateHPPCode(String componentId) {
		...
		ret = ret + "#include \"wm_bica/Component.h\"\n";
		...
		ret = ret + "#include \"wm_bica/Singleton.h\"\n\n";

		ret = ret + "#define "+componentId+"_ID \""+componentId+"\"\n\n";
		...
		ret = ret + "{\n" + "public:\n\n\t" + componentId + "();\n\t" + "~" + componentId + "();\n\n";
		ret = ret + "\tvoid step();\n\n";
		ret = ret + "\tvirtual int getState() { return state;};\n\n";
		
		//ret = ret + "\tstring getState();\n";
	...
	public String generateCPPCode(String componentId) {
		...
		ret = ret + "\tdefault:\n\t\tstd::cout << \"[" + componentId + "::step()] Invalid state\\n\";\n\t}\n";
